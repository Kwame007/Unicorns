  ...
  return (
    <div className="w-full h-fit py-20 bg-indigo-700 text-white flex flex-col justify-center relative">
      ...
      <div className="absolute bottom-0 left-0">
        <img
          alt="Footer Shape"
          data-breeze="https://cdn.uideck.com/wp-content/themes/uideck/assets/images/footer/shape-2.svg"
          src="https://cdn.uideck.com/wp-content/themes/uideck/assets/images/footer/shape-2.svg"
          class="shape shape-2 ls-is-cached br-loaded"
        />
      </div>
    </div>
  );
