            ...
            <form className="flex flex-col">
                ...
                <div className="w-full flex flex-col space-y-6 md:space-y-0 md:flex-row md:gap-x-4"> 
                    <div className="flex-1">
                        <p className="max-w-md text-left pt-2 text-lg text-slate-800 font-normal leading-5">Write about positive experiences you had while in this university. Short, concise and helpful information.</p>
                    ...
                    <div className="flex-1"> 
                        <p className="max-w-md text-left pt-0  md:pt-2 text-lg text-slate-800 font-normal leading-5">Write your negative experiences you had while in this university. Short, concise and helpful information.</p>
                ...
                <div className="w-full my-6"> 
                    <p className="max-w-lg text-left pt-2 text-lg text-slate-800 font-normal leading-5">Write your total university experience while you were enrolled in this university. </p>
