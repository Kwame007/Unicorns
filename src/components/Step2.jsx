            ...
            <form className="flex flex-col">
                ...
                <div className="w-full flex flex-col space-y-6 md:space-y-0 md:flex-row md:gap-x-4"> 
                    <div className="flex-1">
                        ...
                        <input className="w-full mt-4 px-5 py-2 border-2 border-black focus:outline-indigo-500 focus:ring-indigo-200 focus:ring-2 text-xl  placeholder:font-semibold placeholder:text-slate-500 placeholder:text-xl" type="text" placeholder="Pros" onChange={ (e) => { setProsInput(e.target.value), dispatch(setPros(prosInput)) }} ref={prosRef} />
                    </div>
                    <div className="flex-1"> 
                        ...
                        <input className="w-full mt-4 px-5 py-2 border-2 border-black focus:outline-indigo-500 focus:ring-indigo-200 focus:ring-2 text-xl placeholder:font-semibold placeholder:text-slate-500 placeholder:text-xl" type="text" placeholder="Cons" onChange={ (e) => { setConsInput(e.target.value), dispatch(setCons(consInput))} } ref={consRef}/>
                    </div>
                </div>
                <div className="w-full my-6"> 
                    ...
                    <textarea className="w-full h-40 mt-4 p-5 border-2 border-black text-xl  focus:outline-indigo-500 focus:ring-indigo-200 focus:ring-2 placeholder:font-semibold placeholder:text-slate-500 placeholder:text-xl" type="text" placeholder="Please provide your review summary here..." onChange={ (e) => { setSummaryInput(e.target.value),dispatch(setReviewSummary(summaryInput))} } ref={summaryRef}/>
                </div>
            </form>
            </div>
        </>
